...
class VzenseTofCam():
    ...
    def __init__(self):
        if platform.system() == 'Linux':
            libpath = (os.path.abspath(os.path.dirname(__file__)) + os.path.sep + "../../")+"/Lib/libvzense_api.so"
            print(libpath)
            ...
            libpath = (os.path.abspath(os.path.dirname(__file__)) + os.path.sep + "../../")+"/Lib/vzense_api.dll"
            print(libpath)
            self.ps_cam_lib = cdll.LoadLibrary(libpath)    
        else:
