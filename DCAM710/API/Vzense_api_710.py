...
class VzenseTofCam():
    ...
    def __init__(self):
        if platform.system() == 'Linux':
            libpath = os.path.join(os.path.abspath(os.path.dirname(__file__)), "../../", "Lib/libvzense_api.so")
            print(libpath)
            ...
            libpath = os.path.join(os.path.abspath(os.path.dirname(__file__)), "../../", "Lib/vzense_api.dll")
            print(libpath)
            self.ps_cam_lib = cdll.LoadLibrary(libpath)    
        else:
